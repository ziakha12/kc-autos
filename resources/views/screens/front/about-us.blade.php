<script>
    document.title = "About Us | KC Auto Connect";
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8 col-md-10 col-12">
                        <div class="car-text text-center">
                            <h2 class="text-uppercase mb-4">Van and car leasing for business and personal use</h2>
                            <h5 class="text-uppercase">Here at KC Autoconnect, we make car and van leasing simple.</h5>
